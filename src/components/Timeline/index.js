...
export default function Timeline() {
    const projects = [
        ...
        },
        {
            ...
            summary:
                'A fullstack financial planning application that can help you be conscience of your day to day purchases.',
        ...
        },
        {
            ...
            summary:
                'A command line application allows the user to quickly add, view, and update employees, roles, and departments within a company; and have the data stored in a SQL database.',
